...
code or data provided in this repository please cite Oikawa et
al. (2024).
...
**GPP:** The GPP module using a light use efficiency equation to predict
GPP. GPP can be predicted using leaf area index (LAI) or a greenness
index from Phenocam data, or remote sensing such as EVI or NDVI.
PEPRMT-Tidal applied in Oikawa et al. (2024) uses EVI from Landsat.

**R_(eco):** The R_(eco) module uses a Dual Arrhenius Michaelis-Menten
(DAMM) approach to predict R_(eco ~~from two carbon pools.~~)

**CH₄:** The CH₄ module also uses the DAMM approach and includes
inhibition factors to decrease CH₄ production in presence of NO₃ and SO₄
...
streams included continuous NO₃ or salinity measurements are also
included.
...
<patty.oikawa@gmail.com>. Thank you!
